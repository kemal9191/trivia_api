...
def create_app(test_config=None):
    ...
    def delete_question(question_id):
        ...
        question ID as argument, then queries db based on it. Then delete target 
        question. If it can not do the task, it throws a 422 error. 
        '''
        try:
    ...
    def create_question():    
        '''
        This endpoint handles with POST request that aims at creating 
        new questions. It takes necessary data from related structure 
        by using flask request and then create new question using these 
        data. Finally it inserts the question into db, or throws an 
        error if necessary.
        '''
        ...
        try:
            new_question = Question(question=question_body, 
    ...
    def set_quiz():
        '''
        This endpoint handles with quiz play. It takes necessary 
        information form request body (category id and previous questions). 
        Based on that information, it sets the quiz,
